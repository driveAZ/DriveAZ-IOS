...
final class OldCacheManagerTests: XCTestCase {
    ...
    func testDeleteSafetyMessage() throws {
        let idxs = IndexSet([0])
        OldCacheManager.sharedInstance.deleteSafetyMessage(at: idxs)
    }
